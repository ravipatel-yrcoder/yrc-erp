...
CREATE TABLE `inv_product_stock` (
  ...
  `blocked_qty` decimal(15,4) NOT NULL DEFAULT '0.0000',
  `quality_qty` decimal(15,4) NOT NULL DEFAULT '0.0000',
...
CREATE TABLE `inv_serial_stock` (
  ...
  `product_id` bigint unsigned NOT NULL,
  `serial_id` bigint unsigned NOT NULL,
  `state_doc_type` varchar(50) DEFAULT NULL,
  `state_doc_id` bigint unsigned DEFAULT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `inv_serials` (
  ...
  `status` enum('in_stock','reserved','picked','in_transit','sold','returned','quality','blocked','repair','lost','scrapped','consumed') NOT NULL DEFAULT 'in_stock',
...
CREATE TABLE `inv_stock_allocations` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `company_id` int unsigned NOT NULL,
  ...
  `allocation_type` enum('reservation','quality','blocked') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'reservation',
  `quantity` decimal(15,4) NOT NULL DEFAULT '0.0000',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_alloc` (`company_id`,`product_id`,`location_id`,`document_type`,`document_id`,`document_line_id`,`allocation_type`),
...
CREATE TABLE `inv_stock_movements` (
  ...
  `location_id` bigint unsigned NOT NULL,
  `product_id` bigint unsigned NOT NULL,
  `movement_type` enum('adjust_in','adjust_out','transfer_in','transfer_out','purchase_receipt','sale','dn_cancelled','dn_returned','cust_return','cust_return_blocked','cust_return_quality','return_to_supplier','mo_issue','mo_produce','mo_return','scrap','to_blocked','from_blocked','to_quality','from_quality','blocked_to_quality','quality_to_blocked') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
