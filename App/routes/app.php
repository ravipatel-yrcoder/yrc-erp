...
return [
    ...
    "routes" => [
        ...
        "settings" => [
            ...
            [
                "pattern"     => "/settings/documents",
                "name"        => "settings-documents",
                "action"      => "documents",
                "access_keys" => ["company_settings"],
            ],
            [
                "pattern"     => "/settings/documents/quotation",
                "name"        => "settings-doc-quotation",
                "action"      => "docQuotation",
                "access_keys" => ["company_settings"],
            ],
            [
                "pattern"     => "/settings/documents/sales-order",
                "name"        => "settings-doc-sales-order",
                "action"      => "docSalesOrder",
                "access_keys" => ["company_settings"],
            ],
            [
                "pattern"     => "/settings/documents/proforma-invoice",
                "name"        => "settings-doc-proforma-invoice",
                "action"      => "docProformaInvoice",
                "access_keys" => ["company_settings"],
            ],
            [
                "pattern"     => "/settings/documents/purchase-order",
                "name"        => "settings-doc-purchase-order",
                "action"      => "docPurchaseOrder",
                "access_keys" => ["company_settings"],
            ],
            [
                "pattern"     => "/settings/documents/purchase-inquiry",
                "name"        => "settings-doc-purchase-inquiry",
                "action"      => "docPurchaseInquiry",
                "access_keys" => ["company_settings"],
            ],
            [
                "pattern"     => "/settings/doc-sequences",
                "name"        => "settings-doc-sequences-standalone",
                "action"      => "docsequences",
                "access_keys" => ["company_settings"],
            ],
            [
