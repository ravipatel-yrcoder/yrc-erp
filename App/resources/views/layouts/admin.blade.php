<!doctype html>
<html lang="en" class="layout-compact layout-menu-100vh" dir="ltr" data-skin="bordered" data-assets-path="{{asset('/assets/')}}" data-template="vertical-menu-template-no-customizer" data-bs-theme="light">
  <head>
    <meta charset="utf-8" />
...
<body class="bg-gray-50">
    ...
    <nav class="navbar navbar-expand navbar-dark px-4 py-2" style="background:#1e293b; border-bottom:1px solid #334155;">
        <a class="navbar-brand fw-semibold me-4" href="/admin/features" style="font-size:.9rem; letter-spacing:.5px;">ADMIN</a>
        <div class="navbar-nav gap-1">
            <a class="nav-link px-3 py-1 rounded" href="/admin/features" id="nav-features" style="font-size:.85rem;">Features</a>            
        </div>
    </nav>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var path = window.location.pathname;
            if (path.startsWith('/admin/features')) document.getElementById('nav-features').classList.add('active','bg-white', 'text-secondary','bg-opacity-10');            
        });
    </script>
