...
<p style="margin:0 0 32px;font-family:Arial,Helvetica,sans-serif;font-size:15px;color:#374151;line-height:1.6;">
    Thanks for signing up for <strong>{{ $appName }}</strong>. Click the button below to confirm your
    email address and activate your 14-day free trial.
</p>
...
@section('footer_note')
    You received this email because you created an account at {{ $appName }}.<br>
