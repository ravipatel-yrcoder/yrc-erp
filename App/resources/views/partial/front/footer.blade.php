...
<footer class="landing-footer bg-body footer-text">
    ...
    <img
        src="{{asset('/assets/img/front-pages/backgrounds/footer-bg.png')}}" alt="footer bg" class="footer-bg banner-bg-img z-n1" />
    <div class="container">
    ...
    <div
        ...
        <a href="https://www.yrcoder.com" target="_blank" class="text-white">YR Coder,</a>
