@extends('layouts.app')
@section('title', 'Purchase Inquiry Settings')
    ...
    <div class="settings-page-content-wrapper">
        <div class="row g-5">
            ...
            <div class="col settings-content">
                ...
                {{-- Content Sections — Jurisdiction commented out for now, enable when PDF support is ready
                <div class="card shadow-none bg-transparent border mb-4">
                    <div class="card-header">
                ...
                <div class="card shadow-none bg-transparent border mb-4">
                    ...
                    <div class="card-body">
                        <span class="d-block text-muted small mb-2">Prefilled on every new purchase inquiry. Printed at the bottom of the PDF.</span>
...
const _docApiSlug = 'purchase-inquiry';
...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    try {
        ...
        // const el = document.getElementById('showJurisdiction');
        // if (el && data.show_jurisdiction !== undefined) el.checked = !!data.show_jurisdiction;
...
async function saveSettings() {
    ...
    try {
        await api.post('/company/settings/doc/' + _docApiSlug, {
            ...
            sequence: {
                sequence_key:  _sequence.sequence_key || 'purchase_inquiry',
        ...
        notyf.success('Purchase Inquiry settings saved.');
    } catch (err) {
        handleApiError(err);
    } finally {
