        ...
        <div class="row g-5">
            ...
            <div class="col settings-content">
                ...
                <div class="card shadow-none bg-transparent border mb-4">
                    ...
                    <div class="card-body">
                        <span class="d-block text-muted small mb-2">Prefilled on every new purchase order. Printed at the bottom of the PDF.</span>
...
const _docApiSlug = 'purchase-order';
...
async function saveSettings() {
    ...
    try {
        await api.post('/company/settings/doc/' + _docApiSlug, {
            ...
            sequence: {
                sequence_key:  _sequence.sequence_key || 'purchase_orders',
        ...
        notyf.success('Purchase Order settings saved.');
    } catch (err) {
        handleApiError(err);
    } finally {
