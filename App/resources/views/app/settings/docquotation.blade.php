        ...
        <div class="row g-5">
            ...
            <div class="col settings-content">
                ...
                <div class="card shadow-none bg-transparent border mb-4">
                    ...
                    <div class="card-body">
                        @if(!empty($sequence))
                        <p class="text-muted small mb-3">Quotations and Sales Orders share the same number sequence.</p>
                ...
                <div class="card shadow-none bg-transparent border mb-4">
                    ...
                    <div class="card-body">
                        <span class="d-block text-muted small mb-2">Prefilled on every new quotation. Printed at the bottom of the PDF.</span>
...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    try {
        ...
        // show_jurisdiction: 'showJurisdiction'
...
async function saveSettings() {
    ...
    try {
        await api.post('/company/settings/doc/' + _docApiSlug, {
            ...
            // show_jurisdiction commented out — enable when PDF support is ready
            // show_jurisdiction: document.getElementById('showJurisdiction').checked ? 1 : 0,
            terms:                getEditorValue('terms'),
            declaration:          getEditorValue('declaration'),
        });
        notyf.success('Quotation settings saved.');
    } catch (err) {
        handleApiError(err);
    } finally {
