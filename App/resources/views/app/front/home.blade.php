...
<div class="relative flex min-h-screen flex-col items-center justify-center px-6">
    ...
    <div class="absolute right-6 top-6 flex items-center gap-4 text-sm">
      ...
      <a href="{{ url('/login') }}" class="text-slate-600 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white">Log in</a>
      <a href="{{ url('/register') }}" class="inline-flex items-center rounded-lg border px-3 py-1.5 text-slate-700 hover:bg-slate-50 dark:text-slate-200 dark:border-slate-700 dark:hover:bg-slate-800">
        Register
      </a>
