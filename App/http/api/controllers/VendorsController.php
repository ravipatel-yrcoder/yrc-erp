...
class Api_VendorsController extends TinyPHP_Controller {
    ...
    private function serviceVendor(): Service_Vendor {
        return new Service_Vendor(tenantContext());
    }
    ...
    public function checkDuplicateAction(TinyPHP_Request $request) {
        ...
        $service = $this->serviceVendor();
        $result = $service->checkDuplicate($field, $value, $vendorId);
